...
func ScalarMul(v0 []uint64, c uint64) []uint64 {
	vOut := make([]uint64, len(v0))
...
func ElementWiseMul(v0, v1 []uint64) []uint64 {
	vOut := make([]uint64, len(v0))
